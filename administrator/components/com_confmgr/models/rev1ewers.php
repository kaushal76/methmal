...
/**
 * List Model for rev1ewers.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelRev1ewers extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'a.created', 'created',
				'a.ordering', 'ordering','ordering', 'state', 'title', 'first_name', 'surname', 'email', 'affiliation', 'country'
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__confmgr_rev1ewer AS a');				
