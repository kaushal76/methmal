...
<form action="<?php echo JRoute::_('index.php?option=com_confmgr&layout=modal&tmpl=component&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="payment-form" class="form-validate form-horizontal">
