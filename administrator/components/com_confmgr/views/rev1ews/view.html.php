...
/**
 * Rev1ews list view class.
 *
 * @package     Confmgr
 * @subpackage  Views
 */
class ConfmgrViewRev1ews extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ConfmgrHelper::addSubmenu('rev1ews');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CONFMGR_REV1EW_VIEW_REV1EWS_TITLE'));
		...
		if ($canDo->get('core.edit.state'))
		{
            if (isset($this->items[0]->published))
			{
				...
				JToolbarHelper::publish('rev1ews.publish', 'JTOOLBAR_PUBLISH', true);
				JToolbarHelper::unpublish('rev1ews.unpublish', 'JTOOLBAR_UNPUBLISH', true);
            } 
			...
			{
				JToolbarHelper::checkin('rev1ews.checkin');
            }
		}
