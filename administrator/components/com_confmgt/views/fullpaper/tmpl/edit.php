...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            ...
            {
                if (task == 'fullpaper.cancel') {
                    Joomla.submitform(task, document.getElementById('fullpaper-form'));
                }
                else{
				...
				if(js('#jform_presentation').val() != ''){
                    ...
                    if (task != 'fullpaper.cancel' && document.formvalidator.isValid(document.id('fullpaper-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_confmgt&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="fullpaper-form" class="form-validate">
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_CONFMGT_LEGEND_FULLPAPER'); ?></legend>
