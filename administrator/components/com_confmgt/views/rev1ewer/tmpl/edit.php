...
<form action="<?php echo JRoute::_('index.php?option=com_confmgt&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="rev1ewer-form" class="form-validate">
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_CONFMGT_LEGEND_REV1EWER'); ?></legend>
