...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            ...
            {
                if (task == 'themeleader.cancel') {
                    Joomla.submitform(task, document.getElementById('themeleader-form'));
                }
                else{
				...
				if(js('#jform_presentation').val() != ''){
                    ...
                    if (task != 'themeleader.cancel' && document.formvalidator.isValid(document.id('themeleader-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_confmgt&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="themeleader-form" class="form-validate">
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_CONFMGT_LEGEND_THEMELEADER'); ?></legend>
