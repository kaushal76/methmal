...
// Import Class to handle dispatching of events.
require_once JPATH_LIBRARIES . '/joomla/event/dispatcher.php';
...
class InstallJoomlaExtensionFromAPS
{
	...
	function uploadFilesFromZip($p_filename)
	{
		jimport( 'joomla.filesystem.archive' );
	
		try
		{
			JArchive::extract($p_filename, JPATH_BASE);
		}
		catch (Exception $e)
		{
			return false;
