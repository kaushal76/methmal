...
/**
 * Item Model for abstract.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelAbstract extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.abstract';
	 ...
	 */
	public function getTable($type = 'Abstract', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('abstract.id');
