...
/**
 * Item Model for payment.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelPayment extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.payment';
	 ...
	 */
	public function getTable($type = 'Payment', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('payment.id');
