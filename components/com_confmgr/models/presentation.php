...
/**
 * Item Model for presentation.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelPresentation extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.presentation';
	 ...
	 */
	public function getTable($type = 'Presentation', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('presentation.id');
