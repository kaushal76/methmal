...
/**
 * Item Model for rev1ew.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelRev1ew extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.rev1ew';
	 ...
	 */
	public function getTable($type = 'Rev1ew', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('rev1ew.id');
