...
/**
 * Item Model for rev1ewer.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelRev1ewer extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.rev1ewer';
	 ...
	 */
	public function getTable($type = 'Rev1ewer', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('rev1ewer.id');
