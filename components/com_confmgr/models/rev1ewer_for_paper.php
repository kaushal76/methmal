...
/**
 * Item Model for rev1ewer_for_paper.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelRev1ewer_for_paper extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.rev1ewer_for_paper';
	 ...
	 */
	public function getTable($type = 'Rev1ewer_for_paper', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('rev1ewer_for_paper.id');
