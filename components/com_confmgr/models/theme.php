...
/**
 * Item Model for theme.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelTheme extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.theme';
	 ...
	 */
	public function getTable($type = 'Theme', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('theme.id');
