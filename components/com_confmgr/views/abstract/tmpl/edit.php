...
<h2><?php echo JText::_('COM_CONFMGR_ABSTRACT_VIEW_ABSTRACT_TITLE'); ?>: <i><?php echo $this->item->paper_id; ?></i></h2>
...
<form action="<?php JRoute::_('index.php?option=com_confmgr&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	...
	<div>
		<button type="button" class="btn btn-primary" onclick="Joomla.submitform('abstract.apply')"><?php echo JText::_('JAPPLY') ?></button>
		<button type="button" class="btn btn-primary" onclick="Joomla.submitform('abstract.save')"><?php echo JText::_('JSAVE') ?></button>
		<button type="button" class="btn btn-primary" onclick="Joomla.submitform('abstract.save2new')"><?php echo JText::_('JTOOLBAR_SAVE_AND_NEW') ?></button>
		<button type="button" class="btn btn-primary" onclick="Joomla.submitform('abstract.save2copy')"><?php echo JText::_('JTOOLBAR_SAVE_AS_COPY') ?></button>
		<button type="button" class="btn btn-danger" onclick="Joomla.submitform('abstract.cancel')"><?php echo JText::_('JCANCEL') ?></button>
	</div>
