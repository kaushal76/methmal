...
<div class = 'form-horizontal well'>
  <fieldset>
    <div class="paper-edit front-end-edit">
      ...
      <form id="form-paper" role="form" action="<?php echo JRoute::_('index.php?option=com_confmgt&task=abstractform.save'); ?> 
        ...
        <div class="control-group">
          <div class="form-actions">
            ...
            <?php echo JText::_('or'); ?> <a href="<?php echo jroute::_('index.php?option=com_confmgt&task=abstractform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>
