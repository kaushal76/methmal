...
?>
 <div class = 'form-horizontal well'>
    ...
    <form id="form-camerareadypaper" role = "form" action="<?php echo JRoute::_('index.php?option=com_confmgt&task=presentationform.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
