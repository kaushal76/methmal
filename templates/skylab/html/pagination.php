...
function pagination_item_active(&$item) {	
	...
	if(JRequest::getVar('option')=='com_virtuemart') {
		...
		return '<a href="javascript:void(0);" onclick=loadContent("'.$item->link.(strpos($item->link,'?')?'&':'?').'type=raw&limit="+document.getElementById("limit").options[document.getElementById("limit").selectedIndex].value); title="'.$item->text.'">'.$item->text.'</a>';
